 ...
 * contrast to the {@link Client}, distinguishes between an event's {@linkplain EventData#payload() payload} and
 * additional {@linkplain EventData#metaData() meta-data}. While the former is used for storing actual Java objects, the
 * latter one can store additional key-value pairs, if needed.
 *
